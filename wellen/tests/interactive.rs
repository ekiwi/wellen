...
fn test_snapshot_allows_continued_encoding() {
    ...
    encoder.value_change(clk, false);
    encoder.value_change(data, b"0000");
    encoder.time_change(5);
    encoder.value_change(clk, true);
    encoder.value_change(data, b"0011");
    ...
    encoder.value_change(data, b"b1010");
    encoder.time_change(12);
    encoder.value_change(clk, false);
    encoder.value_change(data, b"b1111");
